  ...
  return (
    <div className="app-container">
      ...
      <div className="partition">
        ...
        <div
          className={`section ${
            isListening && role === "Teacher" ? "listening" : ""
          }`}
        >
          <h2>👩‍🏫 Teacher</h2>
          ...
          <div className="audio-player">
            <button
              className="audio-btn"
              onClick={() => playAudio(teacherAudioUrl)}
            >
              🔊 Listen to{" "}
              {role === "Teacher" ? "Your Speech" : "Translated Audio"}
            </button>
          </div>
        ...
        <div
          className={`section ${
            isListening && role === "Student" ? "listening" : ""
          }`}
        >
          <h2>👨‍🎓 Student</h2>
          ...
          <div className="audio-player">
            <button
              className="audio-btn"
              onClick={() => playAudio(studentAudioUrl)}
            >
              🔊 Listen to{" "}
              {role === "Student" ? "Your Speech" : "Translated Audio"}
            </button>
          </div>
